...
if [[ -n $(git status --porcelain) ]]; then
  ...
  git commit -m "Release Hackney Frontend to '$BRANCH_NAME' for testing"
...
echo
echo "✅ To install the pushed branch release run 'npm install --save lbh-frontend#$BRANCH_COMMIT_SHA'"
